...
async function loadSettingsBal(){
  ...
  // Save API keys first so they're available for the balance fetch
  ...
  try{
    ...
    else{if(el)el.textContent=d.balance!=null?Number(d.balance).toFixed(2):"–";}

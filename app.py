...
function initDrawCanvas(){
  ...
  function onDown(e){
    ...
    if(hi<0){
      // No shape hit → deselect and LET chart handle it
      selectedIdx=-1;
      redrawCanvas();
      // Don't preventDefault — chart gets the event for pan/zoom
      return;
    }
  ...
  function onUp(e){
    ...
    if(_mode==='drawing'&&previewShape&&moved){
      ...
      // Keep tool active so user can draw more shapes back-to-back
      redrawCanvas();
      return;
    }

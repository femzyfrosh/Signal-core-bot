  ...
  <div class="main">
    ...
    <div class="page hidden-right" id="page-chart">
      <div class="chart-header">
        ...
        <div class="ch-countdown-row" id="ch-countdown-row" style="display:none">
          <span class="ch-stat-lbl">Closes in</span>
          <span id="candle-countdown" style="font-family:var(--mono);font-size:.78rem;font-weight:700;color:#ffc93c;letter-spacing:.05em;margin-left:4px">00:00</span>
        </div>
        <div class="ch-stats">
      ...
      <div class="tf-bar" id="tf-bar">
        ...
        <button class="tf-btn" data-tf="Min10" onclick="switchTF(this,'Min10')">10m</button>
...
// Update the candle-close countdown display
...
function renderWatchlist(){
  ...
  list.innerHTML=filtered.map(sym=>{
    ...
    return`<div class="wl-row${sig?" has-signal":""}" onclick="openPair('${sym}')">
      ...
      <div class="wl-right">
        <div class="wl-price" style="color:${up?"var(--green)":dn?"var(--red)":"var(--text)"}">${fmtPrice(d.price)}</div>
